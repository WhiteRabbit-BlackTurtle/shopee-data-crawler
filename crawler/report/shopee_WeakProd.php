...
<form action="" method="GET">
  ...
  <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%" style="margin-top:50px">
                  <thead>
                    <tr>
  ...
  <tbody>
    <?php
     if(isset($_GET['start_price']) && isset($_GET['end_price']))
     {
      ...
      // $n = 0;
      $qryRow = tep_query("SELECT *, MIN(sold) AS SoldQty FROM crawler_shopee_product GROUP BY name ORDER BY SoldQty ASC, rating ASC LIMIT 100"); 
